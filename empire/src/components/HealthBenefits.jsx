...
// import lungsImage from '/image/lungs.png'; // Make sure to place this image inside public/image
// import capsuleImage from '/image/capsule.png'; // Make sure to place this image inside public/image
// import leafImage from '/image/leaf.png'; // Make sure to place this image inside public/image
// import heartImage from '/image/heart.png'; // Make sure to place this image inside public/image
// import vitaminImage from '/image/vitamin.png'; // Make sure to place this image inside public/image
// import brainImage from '/image/brain.png'; // Make sure to place this image inside public/image
  ...
  return (
    <div className="max-w-full mx-auto py-12 px-8 relative mt-12">
      <div className="max-w-7xl mx-auto bg-[#E4E9ED] shadow-lg rounded-3xl py-16 md:py-24 p-6" style={{ opacity: 1, transform: 'none' }}>
        ...
        <div className="mb-12">
          <h2 className="text-center text-3xl md:text-5xl font-bold text-[#4284FF] mt-5" style={{ opacity: 1, transform: 'none' }}>
            <span>Health </span>
          ...
          <div className="block lg:hidden">
                ...
                <svg className="w-full h-full" viewBox="0 0 350 350">
                  <defs>
                    <linearGradient id="ringGradientMobile" x1="0%" y1="0%" x2="100%" y2="100%">
                      <stop offset="0%" style={{ stopColor: 'rgb(248, 250, 252)', stopOpacity: 1 }}></stop>
                      <stop offset="100%" style={{ stopColor: 'rgb(226, 232, 240)', stopOpacity: 1 }}></stop>
                    </linearGradient>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
              <div className="w-full rounded-md p-4" style={{ opacity: 0, transform: 'translateY(12px)' }}>
                <h3 className="font-bold text-base mb-2 text-[#4284FF] bg-clip-text">
                  Anthoxanthin
                </h3>
                <div className="text-[13px] bg-gradient-to-r from-blue-700 to-purple-900 text-transparent bg-clip-text font-semibold mb-1">
                  Healthy Bone
                </div>
            ...
            <div className="relative flex justify-center items-center">
              ...
              <div className="absolute w-full h-full">
                <div className="absolute top-8 left-8 w-80 rounded-md p-5">
                  <h3 className="font-bold text-2xl text-[#4284FF] bg-clip-text mb-2">
                    Anthoxanthin
                  </h3>
                ...
                <div className="absolute -bottom-24 left-1/2 transform -translate-x-1/2 translate-y-0 w-80 rounded-md p-5">
                  <h3 className="font-bold text-2xl text-[#4284FF] bg-clip-text mb-2">
                    Anthocyanin
                  </h3>
                  <div className="text-[15px] bg-gradient-to-r from-blue-700 to-purple-900 text-transparent bg-clip-text font-bold mb-1">
