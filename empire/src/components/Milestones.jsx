...
// // import innovationImg from "/image/innovation.png"; // adjust path if needed
...
//               <button className="w-full sm:w-auto bg-[#14089e] text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl text-base sm:text-lg font-medium flex items-center gap-2 shadow-md hover:bg-[#0f0779] transition-colors duration-300">
...
//               {/* Learn More Button */}
//               <button className="w-full sm:w-auto bg-white text-[#14089e] px-6 sm:px-8 py-3 sm:py-4 rounded-xl text-base sm:text-lg font-medium flex items-center gap-2 border-2 border-[#14089e] shadow-md hover:bg-[#14089e] hover:text-white transition-colors duration-300">
